...
/** I am not sure what the namespace is, the autoload path, or the path for uuid  **/
namespace ;
...
/**
 * Admin class for the New Student Self Guided Tour
 * This class will be used to instantiate new admin objects.
 *
 * @author Nehomah <nmora@mail.sipi.edu
 **/
